...
interface Post24DiaCriancaProps {
  slideIndex?: number;
  preview?: boolean;
}

// Fotos de crianças/família - Unsplash royalty free
const slides = [
  {
    image: 'https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=1080&h=1080&fit=crop',
    title: 'DIA DAS',
    highlight: 'CRIANÇAS',
    subtitle: 'Amigo secreto infantil',
    color: '#E74C3C',
    emojis: [
      { emoji: '🧸', top: 8, left: 78 },
  ...
  {
    image: 'https://images.unsplash.com/photo-1489710437720-ebb67ec84dd2?w=1080&h=1080&fit=crop',
    title: 'AMIGO',
    highlight: 'CRIANÇA',
  ...
  {
    image: 'https://images.unsplash.com/photo-1472162072942-cd5147eb3902?w=1080&h=1080&fit=crop',
    title: 'ORGANIZE',
    highlight: 'A FESTA!',
    subtitle: 'Sorteio para todas as idades',
    color: '#9B59B6',
    cta: true,
    emojis: [
      { emoji: '🎉', top: 5, left: 78 },
...
export function Post24DiaCrianca({ slideIndex = 0, preview = true }: Post24DiaCriancaProps) {
      ...
      <div className="relative z-10 flex flex-col items-start justify-end h-full" style={{ padding: preview ? '20px' : '56px' }}>
        ...
        {slide.cta && (
          <div className="mt-5 flex flex-col gap-2">
            ...
            <div className="font-bold animate-pulse" style={{ fontSize: preview ? '12px' : '28px', padding: preview ? '10px 20px' : '16px 36px', background: `linear-gradient(135deg, ${slide.color} 0%, #F5A945 100%)`, color: '#FFFFFF', boxShadow: `0 0 40px ${slide.color}70` }}>Feliz Dia! 🧸</div>
          </div>
        )}
      </div>
