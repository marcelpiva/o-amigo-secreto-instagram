...
interface Post45MulheresOrganizamProps {
  slideIndex?: number;
  preview?: boolean;
}
...
const slides = [
  {
    ...
    bgFrom: '#1a0a20',
    bgVia: '#2a1535',
    image: 'https://images.unsplash.com/photo-1573164713988-8665fc963095?w=1080&h=1080&fit=crop',
  },
  {
    type: 'stat',
    metric: '72%',
    label: 'DOS GRUPOS',
    detail: 'São organizados por mulheres',
    icon: '📊',
    color: '#D4623A',
    bgFrom: '#200a0a',
    bgVia: '#351515',
  ...
  },
  {
    type: 'feature',
    title: 'ELAS CUIDAM',
    points: ['Das datas', 'Das regras', 'Da diversão'],
    icon: '💪',
    color: '#6AAF52',
    bgFrom: '#0a200a',
    bgVia: '#153515',
  ...
  },
  {
    type: 'feature',
    title: 'E AINDA...',
    points: ['Escolhem presentes', 'Montam wishlists', 'Conectam pessoas'],
    icon: '🎁',
    color: '#F5A945',
    bgFrom: '#201a0a',
    bgVia: '#352a15',
  ...
  },
  {
    ...
    title: 'OBRIGADO',
    highlight: 'MULHERES!',
    subtitle: 'Por fazerem a magia acontecer',
    icon: '💜',
    color: '#9B59B6',
    bgFrom: '#1a0a20',
    bgVia: '#2a1535',
...
export function Post45MulheresOrganizam({ slideIndex = 0, preview = true }: Post45MulheresOrganizamProps) {
          ...
          <>
            ...
            <div className="space-y-3">
              {slide.points.map((point, i) => (
                <div
                  key={i}
                  className="px-6 py-3 bg-white/10 backdrop-blur border border-white/20 text-white font-medium"
                  style={{
                    fontSize: preview ? '14px' : '32px',
                    padding: preview ? '12px 24px' : '24px 48px',
                  }}
                >
                  ✨ {point}
                </div>
