...
interface Post22PascoaProps {
  slideIndex?: number;
  preview?: boolean;
}

// Fotos de Páscoa - Unsplash royalty free
const slides = [
  {
    image: 'https://images.unsplash.com/photo-1521967906867-14ec9d64bee8?w=1080&h=1080&fit=crop',
    title: 'PÁSCOA',
    highlight: 'EM FAMÍLIA',
    subtitle: 'Troque presentes especiais',
    color: '#9B59B6',
    emojis: [
      { emoji: '🐰', top: 8, left: 78 },
  ...
  {
    image: 'https://images.unsplash.com/photo-1457301547464-55b8223bcdab?w=1080&h=1080&fit=crop',
    title: 'AMIGO',
    highlight: 'CHOCOLATE',
    subtitle: 'Uma tradição deliciosa',
    color: '#8B4513',
    emojis: [
      { emoji: '🍫', top: 6, left: 80 },
  ...
  {
    image: 'https://images.unsplash.com/photo-1519340241574-2cec6aef0c01?w=1080&h=1080&fit=crop',
    title: 'ORGANIZE',
    highlight: 'O SORTEIO!',
    subtitle: 'Surpreenda nesta Páscoa',
    color: '#D4623A',
    cta: true,
    emojis: [
      { emoji: '🐣', top: 5, left: 78 },
...
export function Post22Pascoa({ slideIndex = 0, preview = true }: Post22PascoaProps) {
      ...
      <div className="relative z-10 flex flex-col items-start justify-end h-full" style={{ padding: preview ? '20px' : '56px' }}>
        ...
        {slide.cta && (
          <div className="mt-5 flex flex-col gap-2">
            ...
            <div className="font-bold animate-pulse" style={{ fontSize: preview ? '12px' : '28px', padding: preview ? '10px 20px' : '16px 36px', background: `linear-gradient(135deg, ${slide.color} 0%, #F5A945 100%)`, color: '#FFFFFF', boxShadow: `0 0 40px ${slide.color}70` }}>Feliz Páscoa! 🐰</div>
          </div>
        )}
      </div>
