...
interface Post23FestaJuninaProps {
  slideIndex?: number;
  preview?: boolean;
}

// Fotos de Festa Junina - Unsplash royalty free
const slides = [
  {
    image: 'https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=1080&h=1080&fit=crop',
    title: 'ARRAIÁ',
    highlight: 'DO AMIGO',
    subtitle: 'Festa junina com troca de presentes',
    color: '#FF6B35',
    emojis: [
      { emoji: '🌽', top: 8, left: 78 },
  ...
  {
    image: 'https://images.unsplash.com/photo-1504196606672-aef5c9cefc92?w=1080&h=1080&fit=crop',
    title: 'AMIGO',
    highlight: 'CAIPIRA',
    subtitle: 'Tradição com diversão',
    color: '#E67E22',
    emojis: [
      { emoji: '🔥', top: 6, left: 80 },
  ...
  {
    image: 'https://images.unsplash.com/photo-1528495612343-9ca9f4a4de28?w=1080&h=1080&fit=crop',
    title: 'ORGANIZE',
    highlight: 'SUA FESTA!',
    subtitle: 'Sorteio fácil e rápido',
    color: '#D4623A',
    cta: true,
    emojis: [
      { emoji: '🎉', top: 5, left: 78 },
...
export function Post23FestaJunina({ slideIndex = 0, preview = true }: Post23FestaJuninaProps) {
      ...
      <div className="relative z-10 flex flex-col items-start justify-end h-full" style={{ padding: preview ? '20px' : '56px' }}>
        ...
        {slide.cta && (
          <div className="mt-5 flex flex-col gap-2">
            ...
            <div className="font-bold animate-pulse" style={{ fontSize: preview ? '12px' : '28px', padding: preview ? '10px 20px' : '16px 36px', background: `linear-gradient(135deg, ${slide.color} 0%, #F5A945 100%)`, color: '#FFFFFF', boxShadow: `0 0 40px ${slide.color}70` }}>Viva São João! 🌽</div>
          </div>
        )}
      </div>
