...
interface Post31TeaserCarnavalProps {
  slideIndex?: number;
  preview?: boolean;
}
...
const slides = [
  {
    ...
    title: 'CARNAVAL',
    highlight: 'VEM AÍ...',
    subtitle: 'E a gente tem uma ideia! 🎭',
    icon: '🎉',
    color: '#F5A945',
    bgFrom: '#1a1505',
    bgVia: '#2a2510',
...
export function Post31TeaserCarnaval({ slideIndex = 0, preview = true }: Post31TeaserCarnavalProps) {
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-8 text-center">
        <div
          ...
          style={{
            ...
            filter: `drop-shadow(0 0 60px ${slide.color}80) drop-shadow(0 0 120px ${slide.color}40)`,
            animationDuration: '2s',
          }}
        >
          {slide.icon}
